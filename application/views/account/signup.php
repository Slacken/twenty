        ...
        <div id="main">
            <article>
                ...
                <div id="sign" class="clearfix">
                    ...
                    <article>
                        <header><h3>或者现在注册</h3></header>
                        <div class="semiform">
                        	<form action="" method="post">
                            	<p class="form-line"><label for="email">电子邮箱&nbsp;</label><input type="email" id="email" name="email" /><span class="error">错误的邮箱地址</span></p>
                                <p class="form-line"><label for="password">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码&nbsp;</label><input type="password" id="password" name="password" /><span class="correct">密码够长</span></p>
